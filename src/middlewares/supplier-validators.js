...
export const createSupplierValidator = [
    ...
    body("contactSupplier").notEmpty().withMessage("El contacto es requerido").isLength({ min: 10, max: 10 }).withMessage("El contacto debe tener 10 dígitos").custom(contactSupplierExists).withMessage("El contacto ya está registrado"),
...
export const updateSupplierValidator = [
    ...
    body("contactSupplier").optional().notEmpty().withMessage("El contacto es requerido").isLength({ min: 10, max: 10 }).withMessage("El contacto debe tener 10 dígitos"),
